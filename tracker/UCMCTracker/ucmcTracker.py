...
from tracker.UCMCTracker.tracker.ucmc import UCMCTrack
from tracker.UCMCTracker.detector.mapper import Mapper
import argparse
import cv2
import numpy as np
...
parser.add_argument('--cam_para', type=str,
                    default="tracker/UCMCTracker/demo/cam_para.txt", help='camera parameter file name')
...
class UCMCTracker:
    def __init__(self, model, fps=25, args=args):
